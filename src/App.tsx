                  ...
                  <ul className="exp-list">
                    ...
                    <li className="exp-item">
                      <details className="exp-details">
                        ...
                        <div className="exp-content">
                          <ul>
                            <li>Провел эвристический анализ интерфейса личного кабинета заявителя</li>
                            <li>Собрал и проанализировал данные Яндекс.Метрики</li>
                            <li>Разработал предложения по редизайну</li>
