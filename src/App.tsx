                  ...
                  <ul className="exp-list">
                    ...
                    <li className="exp-item">
                      <details className="exp-details">
                        ...
                        <div className="exp-content">
                          <ul>
                            <li>Выполнил эвристическую оценку текущего интерфейса, выявив основные "боли" пользователей и критические проблемы юзабилити</li>
                            <li>Провел комплексный анализ данных Яндекс Метрики (посещаемость 23,2 тыс. чел/год) для оценки эффективности сайта</li>
                            <li>Разработал конкретные предложения по оптимизации интерфейса (UI/UX)</li>
                            <li>Участвовал в командной работе по подготовке презентации и отчета</li>
                          </ul>
                        </div>
                      </details>
                    </li>
