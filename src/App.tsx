  ...
  <section id="about" className="about">
    <div className="about-card">
      ...
      <p className="about-text">
        Привет! Я Никита, UX/UI дизайнер. Выпускник магистратуры ВШЭ по
        UX-аналитике и проектированию информационных систем. Моё портфолио – это
        результат учебных проектов, выполненных под руководством профессионалов
        из индустрии. Готов применить свои знания на практике!
      </p>
    </div>
  </section>
);
  ...
  if (typeof window !== "undefined") {
    setTimeout(() => {
      ...
      if (
        ...
        hardBtn &&
        softBtn &&
        !hard.hasAttribute("data-active") &&
        !soft.hasAttribute("data-active")
      ) {
  ...
  return (
    <section id="hard-soft" className="hard-soft">
      <div
        className="hs-header"
        role="tablist"
        aria-label="Hard and soft skills"
      >
        <button
          id="hs-tab-hard"
          className="hs-tab"
                  ...
                  <ul className="exp-list">
                      ...
                      <details className="exp-details">
                        <summary className="exp-summary">
                          <div className="exp-title">
                            Продуктовый дизайнер — Дипломный проект
                          </div>
                          <div className="exp-meta">
                            сентябрь 2024 — май 2025 / 9 месяцев
                          </div>
                        </summary>
                        <div className="exp-content">
                          <ul>
                            <li>
                              Провел глубокий UX-анализ, включая конкурентное
                              исследование и экспертные интервью, для выявления
                              и формализации пользовательских требований.
                            </li>
                            <li>
                              Спроектировал и разработал интерактивный прототип
                              мобильного приложения в Figma, обеспечив его
                              интуитивность и удобство.
                            </li>
                            <li>
                              Разработал системную архитектуру и логику API,
                              заложив основу для создания функционального
                              прототипа.
                            </li>
                            <li>
                              Организовал и провел юзабилити-тестирование
                              прототипа, используя количественные и качественные
                              метрики для оценки его эффективности.
                            </li>
                            <li>
                              Полностью спланировал и управлял всеми этапами
                              проекта — от исследования до разработки
                              функционального прототипа и оценки результатов.
                            </li>
                          </ul>
                        </div>
                      </details>
                    ...
                    <li className="exp-item">
                      <details className="exp-details">
                        <summary className="exp-summary">
                          <div className="exp-title">
                            UI/UX дизайнер — Учебный проект с компанией «ТеДо»
                            (Технологии Доверия){" "}
                          </div>
                          <div className="exp-meta">
                        ...
                        <div className="exp-content">
                          <ul>
                            <li>
                              Проанализировал пользовательский опыт и определил
                              ключевые проблемы текущего интерфейса раздела
                              "Город"
                            </li>
                            <li>
                              Спроектировал и визуализировал концепцию нового
                              решения в виде макетов экранов приложения
                            </li>
                            <li>
                              Разработал дизайн и структуру итоговой
                              proposal-презентации, превратив аналитические,
                              технические и бизнес-идеи команды в понятный и
                              убедительный визуальный сторителлинг для
                              "заказчика".
                            </li>
                            <li>
                              Участвовал в разработке дорожной карты проекта,
                              включая декомпозицию на этапы, оценку сроков и
                              определение состава команды
                            </li>
                            <li>
                              Работал в команде вместе с аналитиками и
                              специалистами по технической части, обеспечивая
                              соответствие дизайн-решений общим целям и
                              техническим возможностям проекта
                            </li>
                          </ul>
                        </div>
                      </details>
                    ...
                    <li className="exp-item">
                      <details className="exp-details">
                        <summary className="exp-summary">
                          <div className="exp-title">
                            UI/UX дизайнер — Учебный проект с компанией «Центр
                            гос. экспертизы»
                          </div>
                          <div className="exp-meta">
                        ...
                        <div className="exp-content">
                          <ul>
                            <li>
                              Выполнил эвристическую оценку текущего интерфейса,
                              выявив основные "боли" пользователей и критические
                              проблемы юзабилити
                            </li>
                            <li>
                              Провел комплексный анализ данных Яндекс Метрики
                              (посещаемость 23,2 тыс. чел/год) для оценки
                              эффективности сайта
                            </li>
                            <li>
                              Разработал конкретные предложения по оптимизации
                              интерфейса (UI/UX)
                            </li>
                            <li>
                              Участвовал в командной работе по подготовке
                              презентации и отчета
                            </li>
                          </ul>
                        </div>
                      </details>
                  ...
                  <ul className="edu-list">
                    ...
                    <li className="edu-item">
                      <div className="edu-card">
                        ...
                        <div className="edu-desc">
                          Онлайн курс по UX дизайну от Google на платформе
                          Coursera
                        </div>
                      </div>
                    </li>
              ...
              <>
                ...
                <section id="portfolio" className="portfolio">
                  <ul className="portfolio-grid">
                      ...
                      >
                        ...
                        <div className="case-body">
                          <h3 className="case-title">
                            Трекер low-FODMAP диеты, Telegram Mini-App
                          </h3>
                    ...
                    <li className="case-card">
                      ...
                      >
                        ...
                        <div className="case-body">
                          <h3 className="case-title">
                            Концепт рекомендательной системы в Т-Банк "Город"
                          </h3>
                          <div className="case-origin">
                            Учебный проект с компанией "ТеДо" (Технологии
                            Доверия)
                          </div>
                        </div>
                      </Link>
                    ...
                    <li className="case-card">
                      ...
                      >
                        ...
                        <div className="case-body">
                          <h3 className="case-title">
                            Сервис заказов речного шеринг-такси
                          </h3>
                  ...
                  <p className="portfolio-note">
                    А ещё этот сайт-портфолио сделан мной. Код можно найти на{" "}
                    <a
                      href="https://github.com/ahamkara-Nh/nkhaliman_portfolio"
                      target="_blank"
