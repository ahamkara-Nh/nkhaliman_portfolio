        ...
        <section className="case-lowfodmap__subject-area">
          ...
          <div className="case-lowfodmap__subject-description">
            <p>
              ...
              элиминация, реинтродукция групп FODMAP, персонализация. <br /><br />Конкурентный анализ показал проблему: 
          ...
          <div className="case-lowfodmap__subject-description">
            <p>
              ...
              <br /><br />Это исследование стало фильтром: оно помогло отсечь лишнее (вроде трекеров сна) и сфокусироваться на проектировании ядра — инструментов, которые реально поддерживают пользователя на его пути через все этапы диеты, а не просто добавляют ему цифрового хаоса.
            </p>
          </div>
...
{/* Phase 3 Screenshots */}
        ...
        {/* Conclusion Section */}
        <section id="conclusion" className="case-lowfodmap__conclusion-section">
          <h2 className="case-lowfodmap__problem-header">Выводы и ограничения</h2>
          <p className="case-lowfodmap__conclusion-description">
            В этом проекте я смог собрать рабочий прототип, который реально упрощает жизнь людям на low‑FODMAP диете и получил неплохой результат по удобству — SUS 78,5. 
            Но это ещё не финал, а только хорошее начало. 
            Чтобы довести продукт до идеала, нужны ещё несколько итераций и более глубокое тестирование. 
            <br /><br /> Из‑за ограниченных времени и ресурсов исследование получилось камерным, поэтому в будущем хочется проверить прототип на более широкой и разнообразной аудитории. 
