          ...
          <div className="case-lowfodmap__interface-showcase">
            ...
            <div className="case-lowfodmap__phase-demos">
              ...
              <div className="case-lowfodmap__phase-demo">
                ...
                На первом этапе разработки я внедрил интуитивный компонент для автоматического отслеживания пищевых записей в дневнике питания. Система анализирует введённые пользователем данные и визуализирует прогресс соблюдения диеты в режиме реального времени. Функция довольно простая, но подобного отслеживания я не встречал ни в одном похожем приложении
                </p>
